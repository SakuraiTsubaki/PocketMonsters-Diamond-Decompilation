# Milestones: Pocket Monsters Diamond

This roadmap governs research, tooling, analysis, reconstruction, and preservation for `SakuraiTsubaki/PocketMonsters-Diamond-Decompilation`.
...
| Field | Current value |
| --- | --- |
| Target | Pocket Monsters Diamond |
...
Coordinate Nintendo DS and NARC findings with Pearl and Platinum; record every offset and layout per verified target.
