...
| Reference only | United States | English | Rev 5 | Nintendo DS; `NTR-ADAE-USA`; 2007-04-22 | SHA-1 `a46233d8b79a69ea87aa295a0efad5237d02841e`; MD5 `02a1af2a677d101394b1d99164a8c249`; CRC32 `84427823` | PRET matching target; preservation/compatibility metadata independently identifies the same build as USA Rev 5. Sources `D-SRC-0003`, `D-SRC-0005`, `D-SRC-0007`, `D-SRC-0021`. |
...
| Reference only | Europe | English | **Rev 5 favored; legacy `Rev 13` label preserved** | Nintendo DS; `NTR-ADAP-EUR`; 2007-07-27 | SHA-1 `66d2fbfb0dbc1f86a3d726971196989b950092bc`; MD5 `ca7620b92665a2565b5c1831f5f66ec0` | Current No-Intro Wiki/modern technical sources identify day-1 ADAP carts or this hash as Rev 5. A 2017-11-14 No-Intro-derived OpenRetro record and older cheat/ROM-set metadata label the same hash Rev 13. Treat Rev 13 as a historical/legacy alias unless an authoritative changelog proves otherwise; exact relabeling reason remains TBD. See `versions/diamond-retail-revision-research.md`. |
| Reference only | Germany | German | Rev 5 | Nintendo DS; `NTR-ADAD-NOE`; 2007-07-27 | SHA-1 `432dbe312bc51e36bb8cb6fcb5e08f6968f124a4`; MD5 `0683ef614f0cef8228db7676c074c18e`; CRC32 `87CF7B1F` | Public preservation and compatibility metadata agree on the Rev 5 identity. Sources `D-SRC-0003`, `D-SRC-0008`, `D-SRC-0015`, `D-SRC-0021`. |
| Reference only | Spain | Spanish | Rev 5 | Nintendo DS; `NTR-ADAS-ESP`; 2007-07-27 | MD5 `1dea9d321d8413a43dbd6e793bdfdec0`; CRC32 `AA3E6B39`; SHA-1 TBD | Rev 5 identity now has independent compatibility/hash metadata; SHA-1 still to locate from a preservation source. Sources `D-SRC-0003`, `D-SRC-0006`, `D-SRC-0009`, `D-SRC-0021`. |
| Reference only | France | French | Rev 5 | Nintendo DS; `NTR-ADAF-FRA`; 2007-07-27 | SHA-1 `e961e632ca6f72f81e19c5be3d93936772e8544a`; MD5 `da0382f57cee0f6807f43a61a68c0520`; CRC32 `2E6901A8` | Rev 5 identity is cross-checked by independent compatibility metadata; SHA-1 still originates from a secondary preservation/catalog source and should be corroborated cleanly. Sources `D-SRC-0003`, `D-SRC-0010`, `D-SRC-0014`, `D-SRC-0021`. |
| Reference only | Italy | Italian | Rev 5 | Nintendo DS; `NTR-ADAI-ITA`; 2007-07-27 | MD5 `1920fc6a66b3bf4bff2062044f61f4eb`; CRC32 `1ED511AB`; SHA-1 TBD | Rev 5 identity now has independent compatibility/hash metadata; SHA-1 still to locate from a preservation source. Sources `D-SRC-0003`, `D-SRC-0006`, `D-SRC-0011`, `D-SRC-0021`. |
| Planned | South Korea | Korean | unknown | Nintendo DS; `NTR-ADAK-KOR`; 2008-02-14 | TBD | Korean-localized retail release is documented; distinct public technical target and Korean-specific RAM/code address base are known, but clean-dump revision/hash identity remains unresolved. Sources `D-SRC-0003`, `D-SRC-0012`, `D-SRC-0013`; detailed leads in `versions/diamond-retail-revision-research.md`. |
...
- Current evidence favors **Rev 5** for English Europe SHA-1 `66d2fbfb0dbc1f86a3d726971196989b950092bc`. The legacy **Rev 13** name is preserved because it appears in a 2017 No-Intro-derived snapshot and downstream technical databases. The exact history/reason of that metadata correction remains unresolved.
- A shared product code, barcode, language, or release date does **not** establish byte identity. Regional packaging records and binary identities remain separate questions.
...
9. When two sources apply different revision labels to the same cryptographic hash, preserve the hash as the stable identity, retain historical labels, and state which label is favored by current evidence without inventing the reason for any relabeling.
