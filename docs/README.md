...
| [Diamond non-retail software](versions/diamond-non-retail-software.md) | Kiosk/demo, recovery/service software, and development/debug leads kept separate from retail revisions |
